namespace Mint.Substrate
{
    ...
    public class LookupTable
    {
        ...
        public bool IsIncludedProperty(string property,  out string defaultValue)
        {
        ...
        public bool IsReplaceNuGet(string name, out string replaceName)
        {
            return this.refsTable.Replacement.TryGetValue(name, out replaceName);
        }

        public bool IsDefinedNuGet(string name,  out string actualName,  out string version)
        {
        ...
        public bool IsSDK(string name,  out string actualName)
        {
            return this.refsTable.KnownSDKs.TryGetValue(name, out actualName);
        }

        public bool IsKnownNuGet(string name,  out string actualName)
        {
            return this.refsTable.KnownNuGets.TryGetValue(name, out actualName);
        }

        public bool IsExcludedNuGet(string name,  out string actualName)
        {
        ...
        public bool IsProducedProject(string assemblyName,  out IProject project)
        {
            return this.projTable.ProducedProjects.TryGetProject(assemblyName, out project);
        }

        public bool IsCppProject(string assemblyName,  out string actualName)
        {
