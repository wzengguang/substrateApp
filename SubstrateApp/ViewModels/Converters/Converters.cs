...
namespace SubstrateApp.ViewModels
{
    ...
    public static class Converters
    {
        ...
        public static bool ListIsNullOrEmpty(IEnumerable<object> value) => value == null || value.Count() == 0;

        public static string ToRichString(IEnumerable<string> lists) => string.Join("\r\n", lists);
